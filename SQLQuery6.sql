SELECT TOP (1000) [varient_id]
  ...
  INSERT INTO [PaintUpdated].[pup].[product_varient]
(
    [product_id],
    [base_type],
    [pack_size_lt],
...
(11,'Deep Base',1.00,'SKU027',195.00,330.00),
(11,'Deep Base',4.00,'SKU028',720.00,1080.00),
(10,'Clear Base',1.00,'SKU029',200.00,340.00),
(13,'Clear Base',10.00,'SKU030',1450.00,2150.00);